...
window.dreamsGuardian={
	...
	GuardianMoisturizer: {
		...
		chance: 10,
		highestStartPriority: 0,
		description: "$guardian is in front of the bathroom mirror, getting ready for the day. The fiddles around with a bottle, pushing dispenser, but the bottle is empty.\n\n@@.guardiandream;“The moisturizer is empty.”@@ she says as she turns to you.\n\nFor some reason, you are naked. $guardian bends down to examine your ball-sack.\n\n@@.guardiandream;“But these are nice and full.”@@ she comments while fondling your scrotum. @@.guardiandream;“When did you last cum?”@@\n\n“<<print window.timeCode.minutesToStr(playerCode.masturbate.sinceLastCum())>>” you answer truthfully.\n\n@@.guardiandream;“<<if playerCode.masturbate.sinceLastCum() > 2880>>It works best when they are full and ripe.<<else>>That will have to do.<<endif>>”@@\n\n$guardian caresses your caged cock with one hand while positioing the other below. Then she squeezes the cage twice. Each time, you can feel your penis pulse and you spurt a white substance into her hand. On the cupboard, you notice the bottle. Its curved dispenser looks very similar to your chastity device.\n\n$guardian proceeds to apply your personally delivered moisurizer to her face and hands. Then she gives you the empty bottle and a dildo.\n\n@@.guardiandream;“Sweetie, please fill up the bottle for me while I am away, will you?”@@\n\nShe kisses you on the forehead and leaves. Your penis twitches in anticipation, looking forward to the anal orgasms.\n",
		check: function() {
